...
using IrcClient.UI.Views;
using Serilog;

namespace IrcClient.UI;

/// <summary>
/// The main application class for the IRC client.
...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        Log.Information("IRC Client starting up (Portable mode: {IsPortable})", PortableMode.IsPortable);
    ...
    {
        Log.Information("IRC Client shutting down");
